...
public class SwiperFlingAdapterView extends BaseFlingAdapterView {
    ...
    public SwiperFlingAdapterView(Context context) {
        this(context, null);
    }

    public SwiperFlingAdapterView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.SwipeFlingStyle);
    }

    public SwiperFlingAdapterView(Context context, AttributeSet attrs, int defStyle) {
